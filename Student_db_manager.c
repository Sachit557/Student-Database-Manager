...
int srn_checker()                                                    
{
    ...
    while ( attempts < 5)
    {
        ...
        for ( int i = 0 ; i < student_count; i++)
        {
            ...
            else if(strcmp(input_srn , Admin_acess) == 0)
            {   
                printf("ADMIN ACESS ENABLED");
                printf("that feature isnt added yet \n");                                   // gotta implement admin mode
                return -2;
            }   
...
void account_view()
{
      ...
      if ( index != -1 && index != -2)
      {
            ...
            printf("SRN - %s" , students[index].srn);
            printf("Name - %s" , students[index].name);
            printf("Branch - %s" , students[index].branch);
            printf("CGPA - %f" , students[index].cgpa);
            printf("-------------------------------------------- \n");
      }
